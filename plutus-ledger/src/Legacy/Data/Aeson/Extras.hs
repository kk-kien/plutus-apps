-- Restored from https://github.com/input-output-hk/plutus/pull/4394/files#diff-ef698a2dc99506e6567778d80a32e8e1e98dd68e1904e5d1171c5d78d65799c0

-- | Encoding and decoding of 'ByteString' and serialisable values
--   as base16 encoded JSON strings
module Legacy.Data.Aeson.Extras(
      encodeByteString
    , decodeByteString
    , encodeSerialise
    , decodeSerialise
